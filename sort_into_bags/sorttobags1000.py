...
for j in range(1079, 1500): #len(train_vid_files)
    # get single file
    ...
    try: 
        ...
        for i in range(0, images.shape[0]):
            ...
            print(str(i), str(j))
            if abs(label) <= 5 :
                path = '../../data/commaai/train_bags_2/0/'
            ...
            if abs(label) <= 10 and abs(label) > 5:
                path = '../../data/commaai/train_bags_2/1/'
                filename = str(path + str(i) + '_' + str(j) + 'run1.png')
                with open(str(path + 'angles_filename.csv'), 'a') as csvfile:
                    writer = csv.writer(csvfile)
                    writer.writerow([filename, label, tr_label])
                ...
                path = '../../data/commaai/train_bags_2/2/'
                filename = str(path + str(i) + '_' + str(j) + 'run1.png')
                with open(str(path + 'angles_filename.csv'), 'a') as csvfile:
                    writer = csv.writer(csvfile)
                    writer.writerow([filename, label, tr_label])
                ...
                path = '../../data/commaai/train_bags_2/3/'
                filename = str(path + str(i) + '_' + str(j) + 'run1.png')
                with open(str(path + 'angles_filename.csv'), 'a') as csvfile:
                    writer = csv.writer(csvfile)
                    writer.writerow([filename, label, tr_label])
                ...
                path = '../../data/commaai/train_bags_2/4/'
                filename = str(path + str(i) + '_' + str(j) + 'run1.png')
                with open(str(path + 'angles_filename.csv'), 'a') as csvfile:
                    writer = csv.writer(csvfile)
                    writer.writerow([filename, label, tr_label])
                ...
                path = '../../data/commaai/train_bags_2/5/'
                filename = str(path + str(i) + '_' + str(j) + 'run1.png')
                with open(str(path + 'angles_filename.csv'), 'a') as csvfile:
                    writer = csv.writer(csvfile)
                    writer.writerow([filename, label, tr_label])
                ...
                path = '../../data/commaai/train_bags_2/6/'
                filename = str(path + str(i) + '_' + str(j) + 'run1.png')
                with open(str(path + 'angles_filename.csv'), 'a') as csvfile:
                    writer = csv.writer(csvfile)
                    writer.writerow([filename, label, tr_label])
                ...
                path = '../../data/commaai/train_bags_2/7/'
                filename = str(path + str(i) + '_' + str(j) + 'run1.png')
                with open(str(path + 'angles_filename.csv'), 'a') as csvfile:
                    writer = csv.writer(csvfile)
                    writer.writerow([filename, label, tr_label])
                ...
                path = '../../data/commaai/train_bags_2/8/'
                filename = str(path + str(i) + '_' + str(j) + 'run1.png')
                with open(str(path + 'angles_filename.csv'), 'a') as csvfile:
                    writer = csv.writer(csvfile)
                    writer.writerow([filename, label, tr_label])
                ...
                path = '../../data/commaai/train_bags_2/9/'
                filename = str(path + str(i) + '_' + str(j) + 'run1.png')
                with open(str(path + 'angles_filename.csv'), 'a') as csvfile:
                    writer = csv.writer(csvfile)
                    writer.writerow([filename, label, tr_label])
                ...
                path = '../../data/commaai/train_bags_2/10/'
                filename = str(path + str(i) + '_' + str(j) + 'run1.png')
                with open(str(path + 'angles_filename.csv'), 'a') as csvfile:
                    writer = csv.writer(csvfile)
                    writer.writerow([filename, label, tr_label])
