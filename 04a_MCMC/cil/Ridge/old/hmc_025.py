...
for m in tqdm(range(1, M - 1)):
    ...
    if ((m % 100 == 0) & (m > 1)):
        ...
        np.save('../../../../data/commaai/mcmc/unfiltered_gaussian_resampled/Ridge/all_thetas_L100_152.npy', np.array(all_thetas))
        np.save('../../../../data/commaai/mcmc/unfiltered_gaussian_resampled/Ridge/acc_L100_152.npy', np.array(acc))
    #if m < tune:
...
np.save('../../../../data/commaai/mcmc/filtered_gaussian_resampled/Ridge/all_thetas_L50.npy', np.array(all_thetas))