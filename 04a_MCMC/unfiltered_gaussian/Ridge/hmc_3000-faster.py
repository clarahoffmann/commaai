...
for m in tqdm(range(1, M - 1)):
    ...
    if ((m % 50 == 0) & (m > 1)):
        ...
        np.save('../../../../data/commaai/mcmc/unfiltered_gaussian_resampled/Ridge/all_thetas_L3000.npy', np.array(all_thetas))
    #if m < tune:
...
np.save('../../../../data/commaai/mcmc/filtered_gaussian_resampled/Ridge/all_thetas_L3000.npy', np.array(all_thetas))