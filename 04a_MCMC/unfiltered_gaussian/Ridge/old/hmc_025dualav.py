...
for m in tqdm(range(1, M - 1)):
    ...
    if ((m % 100 == 0) & (m > 1)):
        ...
        np.save('../../../../data/commaai/mcmc/unfiltered_gaussian_resampled/Ridge/all_thetas_L50dualav.npy', np.array(all_thetas))
...
np.save('../../../../data/commaai/mcmc/filtered_gaussian_resampled/Ridge/all_thetas_L50dualav.npy', np.array(all_thetas))