...
hmc_horse = dens_pred.compute_dens('va_horseshoe')

np.save('../../../../data/commaai/calibration/cpl_dens/va_horse_av_dens.npy', hmc_horse['av_density'])
...
np.save('../../../../data/commaai/calibration/cpl_dens/va_horse_cdf_is.npy', cdf_va_is)