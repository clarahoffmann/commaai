...
np.save('../../../../data/commaai/calibration/cpl_dens/hmc_horse_av_dens.npy', hmc_horse['av_density'])
...
np.save('../../../../data/commaai/calibration/cpl_dens/hmc_horse_cdf_is.npy', cdf_va_is)