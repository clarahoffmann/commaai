...
hmc_ridge = dens_pred.compute_dens('va_ridge')
np.save('../../../../data/commaai/calibration/cil_dens/hmc_ridge_av_dens.npy', hmc_ridge['av_density'])

# hmc_ridge
densities = hmc_ridge['densities']
cdf_va_is = []
j = 0
