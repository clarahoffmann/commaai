...
hmc_horse = dens_pred.compute_dens('hmc_ridge')

np.save('../../../../data/commaai/calibration/cpl_dens/hmc_ridge_av_dens.npy', hmc_horse['av_density'])
...
np.save('../../../../data/commaai/calibration/cpl_dens/hmc_ridge_cdf_is.npy', cdf_va_is)