...
for i in tqdm(range(iterations)):
    ...
    if i%1000 == 0:
        np.save('../../../../data/commaai/va/unfiltered_gaussian_resampled/Ridge/lower_bounds_factor_50.npy', lower_bounds)
        np.save('../../../../data/commaai/va/unfiltered_gaussian_resampled/Ridge/vartheta_factor_50.npy', np.array(all_varthetas))
        np.save('../../../../data/commaai/va/unfiltered_gaussian_resampled/Ridge/mu_ts23_factor_50.npy', mu_ts)
        np.save('../../../../data/commaai/va/unfiltered_gaussian_resampled/Ridge/d_ts23_factor_50.npy', d_ts)
        np.save('../../../../data/commaai/va/unfiltered_gaussian_resampled/Ridge/B_ts23_factor_50.npy', B_ts)
