...
for i in tqdm(range(iterations)):
    ...
    if (i % 1000 == 0):
        ...
        np.save('../../../../data/commaai/va/unfiltered_gaussian_resampled/Horseshoe/all_varthetas.npy', all_varthetas)
        np.save('../../../../data/commaai/va/unfiltered_gaussian_resampled/Horseshoe/Lambda_ts.npy', Lambda_ts)
