...
for i in tqdm(range(iterations)):
    ...
    t = t+1
    if i % 1000 == 0:
        np.save('../../../../data/commaai/va/filtered_gaussian_resampled/Ridge2/lower_bounds.npy', lower_bounds)
        np.save('../../../../data/commaai/va/filtered_gaussian_resampled/Ridge2/vartheta.npy', np.array(all_varthetas))
        np.save('../../../../data/commaai/va/filtered_gaussian_resampled/Ridge2/mu_ts.npy', mu_ts)
        np.save('../../../../data/commaai/va/filtered_gaussian_resampled/Ridge2/d_ts.npy', d_ts)
        np.save('../../../../data/commaai/va/filtered_gaussian_resampled/Ridge2/B_ts.npy', B_ts)
