...
mc_samples = 1000
preds = []
for i in tqdm(range(0, int(len(all_img_df)/2))):
    ...
    preds.append(pred)
    if i % 100 == 0:
        np.save('../../../../data/commaai/predictions/mc_dropout/mc_preds_cil_y_1.npy', np.array(preds))
preds = np.array(preds)

np.save('../../../../data/commaai/predictions/mc_dropout/mc_preds_cil_y_1.npy', preds)
